...
class Model(models.Model):
    ...
    make = models.ForeignKey(Make, on_delete=models.CASCADE, related_name='models', verbose_name='Марка')
...
class Cars(models.Model):
    ...
    make = models.ForeignKey(Make, on_delete=models.CASCADE, max_length=30, null = False, blank = True, verbose_name="Марка автомобиля")
    model = models.ForeignKey(Model, on_delete=models.CASCADE, max_length=30, null = False, blank = True, verbose_name="Модель авто")
    car_type = models.CharField(max_length=1, choices=kuzov, null = False, blank = True, verbose_name="Тип кузова")
    ...
    color = models.CharField(max_length=20, null=False, blank=True, verbose_name="Цвет авто")
    fuel_type = models.CharField(max_length=1, choices=fuel, verbose_name="Тип топлива")
    Mileage = models.IntegerField(null=False, blank=True, verbose_name='Пробег')
...
class Moto(models.Model):
    ...
    price = models.FloatField(null = False, blank = True, verbose_name="Цена")
    condition = models.CharField(max_length=1, choices=conditions, default='s', verbose_name="Состояние")
    main_gear = models.CharField(max_length=1, choices=gear, null=False, blank=True, verbose_name='Главная передача')
    color = models.CharField(max_length=20, null=False, blank=True, verbose_name="Цвет транспорта")
    Mileage = models.IntegerField(null=False, blank=True, verbose_name='Пробег', default=0)
