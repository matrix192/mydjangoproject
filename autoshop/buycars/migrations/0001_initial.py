# Generated by Django 5.1.5 on 2025-04-12 19:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('make', models.CharField(blank=True, max_length=40, verbose_name='Марка автомобиля')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('make', models.CharField(blank=True, max_length=30, verbose_name='Марка мотоцикла')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='buycars.cars', verbose_name='Автомобиль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Дата добавления')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
                ('moto', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='buycars.moto', verbose_name='Мотоцикл')),
            ],
            options={
